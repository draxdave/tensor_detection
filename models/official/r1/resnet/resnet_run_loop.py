...
def resnet_model_fn(features, labels, mode, model_class,
  ...
  # Create a tensor named cross_entropy for m_util purposes.
  ...
  if mode == tf.estimator.ModeKeys.TRAIN:
    ...
    # Create a tensor named learning_rate for m_util purposes
  ...
  # Create a tensor named train_accuracy for m_util purposes
