...
def main():
  global input_type, pipeline_config_path, output_directory, trained_checkpoint_prefix
...
def run(it, pcp, od, tcp):
    global input_type, pipeline_config_path, output_directory, trained_checkpoint_prefix
    input_type=it
    pipeline_config_path=pcp
    output_directory=od
    trained_checkpoint_prefix=tcp
